...
<div class="oauth-buttons" class:compact>
  ...
  >
    ...
    {#if !compact}<span>{o.google}</span>{/if}
  </button>
  ...
  >
    ...
    {#if !compact}<span>{o.apple}</span>{/if}
    <span class="badge-soon">{o.comingSoon}</span>
  </button>
  ...
  >
    ...
    {#if !compact}<span>{o.github}</span>{/if}
  </button>
</div>
