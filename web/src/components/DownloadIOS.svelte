<script lang="ts">
  // Stub component for iOS app download
  // Will be connected to actual App Store link when available
</script>
...
>
  ...
  <div class="badge-text">
    <span class="sub">Coming to the</span>
